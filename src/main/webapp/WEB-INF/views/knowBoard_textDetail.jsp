...
<%--                            <dd><input type="text" name="seq" id="seq" value="${board.seq}" readonly="readonly"/></dd> --%>
                           <dd><input type="hidden" name="seq" id="seq" value="${board.seq}" readonly="readonly"/><span name="seq" id="seq">${board.seq}</span></dd>
                       </dl>
                       <dl>
                           <dt>글쓴이</dt>
                           <dd><span>${board.writer}</span></dd>
                       </dl>
                       <dl>
                           <dt>작성일</dt>
                           <dd><span>${board.postingdate}</span></dd>
                       </dl>
                       <dl>
                           <dt>조회</dt>
                           <dd><span>${board.hits}</span>
<%--                            <input type="text" value="${board.hits}" name="hits" readonly="readonly"> </dd> --%>
	...
	%>
		<div class="writeCommentBox">
			<input type="hidden" value="<%=nickname%>" id="nickname"><span id="nickname"><%=nickname%></span>
...
<!-- 				<img alt="" src="resources/assets/img/bookmark.png" style="width: 15px"> -->
		...
		<c:forEach items="${commentList}" var="comment">
			<div class="c_box_area">
			
				<div class="viewCommentContentBox">
					<img alt="프로필사진" src="resources/assets/img/user1.jpg" class="profilePicture " style="width: 30px">
					...
					<div class="viewCommentContentBox">
						...
						<%
							// 로그인안한 사용자가 들어오면 튕겨내는것 - 이페이지를 f볼때는 세션이 필요하다!
							if (session.getAttribute("nickname") != null) {
						%>
						<input class="comment_info_button" value="답글쓰기" readonly="readonly">
					  <c:if test="${sessionScope.userId == comment.nickname}">
